...
It allows users to easily use semantic processing tasks, so that they can reuse them in their deployments or even incorporate new functionalities to share with other researchers. 
