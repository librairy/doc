...
Furthermore, an item may contain zero or more parts and one or more topics. In turn, a part only belongs to one item and a topic can be present to more than one item.  
