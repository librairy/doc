...
Furthermore, an item may contain zero or more parts and may belong to one or more topics. In turn, a part only belongs to one item and a topic can be present in more than one item.  
